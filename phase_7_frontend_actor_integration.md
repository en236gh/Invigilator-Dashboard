...
1. `GET /api/admin/invigilator-assignments/exam-sessions/{examSessionId}/staffing` to show allocated students, required invigilators, draft/published counts, and `staffingStatus` per venue.
